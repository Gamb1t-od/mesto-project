const initialCards = [
    {
      name: 'Архыз',
      link: 'https://pictures.s3.yanex.net/frontend-developer/cards-compressed/arkhyz.jpg'
    },
    {
    ...
    {
      name: 'Иваново',
      link: 'https://pictures.s3.yandex.net/frontend-developr/cards-compressed/ivanovo.jpg'
    },
    {
      name: 'Камчатка',
...
function AddCard(evt){
  ...
  element.querySelector('.element__image').alt = nameInputCard.value;
...
elements.addEventListener('click',function(evt)
{
  ...
  if (target.id === 'element__image'){
    ...
    popupEditPic.alt = target.nextElementSibling.textContent;
    popupEditText.textContent = target.nextElementSibling.textContent;
    console.log(target);
